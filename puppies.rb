...
def some_puppies(number_of_found_puppies, maximum_puppy_allowance)
if number_of_found_puppies > maximum_puppy_allowance/2
  "Get back to your animal goals!"
elsif number_of_found_puppies < maximum_puppy_allowance
  "Good job, Rachel!"
end
end
